...
function OrgCartSkeleton() {
  return (
    <div
      className={`w-full h-[130px] sm:h-[140px] md:h-[150px] lg:h-[162px] bg-foreground/25  border rounded-[32px] after:absolute after:block after:top-0 after:left-0 after:z-10 after:bg-darkBlue/60 after:w-full after:h-full after:rounded-[32px] relative  p-3 lg:p-4`}
    >
