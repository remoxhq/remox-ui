...
function About() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div>
        <p className="font-semibold text-[22px] sm:text-[24px] md:text-[28px] text-whitish py-5 md:text-left text-center">Features</p>
      ...
      <div className="my-12 sm:my-16 md:my-20">
        <p className="font-semibold text-[22px] sm:text-[24px] md:text-[28px] text-whitish py-5 md:text-left text-center">Investors</p>
      ...
      <div className="mb-10 sm:mb-14 md:mb-20">
        <p className="font-semibold text-[22px] sm:text-[24px] md:text-[28px] text-whitish py-5 text-center sm:text-left">Social</p>
