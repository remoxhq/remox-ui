...
function Portfolio() {
  ...
  const {
    data: archiveData,
    isPending: isArchiveDataPending,
    isSuccess: isArchiveDataSuccess,
    isError: isArchiveDataError,
                  ...
                  <div className="flex items-center gap-2 h-[26px] mb-4">
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button variant={"outline"} className="rounded-[8px] bg-foreground text-whitish text-xs font-semibold p-0 h-auto py-1 px-1 w-[110px]">
                ...
                <div className="w-[calc(100%-460px)] ml-3 ">
                  ...
                  <span
                    className={`font-semibold text-xl ${
                      (archiveCalculation?.secondDateTotalUsdValue ?? 0) - (archiveCalculation?.firstDayTotalUsdValue ?? 0) > 0 ? "text-green" : "text-red"
                    }`}
                  >
              ...
              <div className="flex items-center *:overflow-hidden w-full *:py-2 ">
                ...
                <div className="w-[calc(100%_-_440px)] pl-3">
                  <div className="flex items-center mb-2 *:w-1/3">
                    <p className="font-semibold text-xs text-whitish text-left">Asset</p>
                    <p className="font-semibold text-xs text-whitish text-center">USD</p>
                    <p className="font-semibold text-xs text-whitish text-right">Holdings</p>
                  </div>
                </div>
              </div>
              {archiveCalculation &&
                archiveCalculation.data.map((item) => (
                    ...
                    <div className="w-[calc(100%_-_439.5px)] pl-2">
                      <div className="flex items-center justify-between w-full group-odd:bg-foreground rounded-[2px] p-1 *:w-1/3 *:overflow-hidden">
                        ...
                        <div className="text-right">
                          ...
                          >
                            {item.tokenCount.percentageChange}%
                          </p>
                        </div>
                      </div>
                    </div>
